  ...
  implements Resolve<PaginatedResult<PropertyMetadataDetails[]>>
{
  ...
  resolve(
    ...
    return this.propertyService
      .getPropertiesMetadatas(sourceId, this.pageNumber, this.pageSize)
      .pipe<PaginatedResult<PropertyMetadataDetails[]>>(
        catchError<PaginatedResult<PropertyMetadataDetails[]>, Observable<any>>(
          (error) => {
