...
export class KafkaRegisterComponent implements OnInit {
  ...
  protected kafkaTopic: SourceTopicDetails = {
    id: 0,
    sourceId: 0,
    topicName: '',
  };
  protected existKafkaTopicConfigured: boolean = false;
  ...
  addOrUpdateKafkaTopic() {
    this.topicService.addOrUpdateKafkaTopic(this.kafkaTopic).subscribe(
      (next: any) => {
        this.alertify.success(
          !this.existKafkaTopicConfigured
